...
sudo ./content/motd/training-motd.sh --install
```
...
./core/lpic-check topic 101

# See detailed results
./core/lpic-check objective 101.1 --verbose
```
...
```bash
# Summary
./core/lpic-check progress

# Detailed by topic
./core/lpic-check progress --detailed

# Export for review
./core/lpic-check progress --export > my-progress.json
```
...
./core/lpic-check exam-mode --time 90

# Random objectives, no hints
./core/lpic-check exam-mode --random --no-hints

# Full exam simulation (60 questions, 90 min)
./core/lpic-check exam-mode --full
```
