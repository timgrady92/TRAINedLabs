...
Create `core/objectives/<objective-id>.sh`:
...
```bash
# Run your validator
./core/objectives/103.5.sh

# Run with verbose
./core/objectives/103.5.sh true

# Test via lpic-check
./core/lpic-check objective 103.5 --verbose
```
...
- `core/objectives/101.1.sh` - Basic validator
- `core/objectives/104.5.sh` - Validator with temp files
