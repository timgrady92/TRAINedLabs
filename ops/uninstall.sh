...
#
# Usage: sudo /opt/LPIC-1/ops/uninstall.sh [--purge]
...
if [[ -x "$INSTALL_DIR/content/environment/unmount-practice-filesystems.sh" ]]; then
    "$INSTALL_DIR/content/environment/unmount-practice-filesystems.sh" || true
else
    # Manual unmount
